...
const SocialIcons = (props, context) => {
  ...
  return (
    <div className="social-icons animate-icons">
        <a target="_blank" rel="noopener noreferrer" href="https://github.com/dylovell" style={ { color: colorPrimary } }><i className="fab fa-github"></i></a>
        ...
        <a target="_blank" rel="noopener noreferrer" href="https://www.linkedin.com/in/dylanlovell" style={ { color: colorPrimary } }><i className="fab fa-linkedin"></i></a>
